...
CREATE TABLE PAGO (IDPAGO INTEGER NOT NULL AUTO_INCREMENT, VALORPAGO DECIMAL(38) NOT NULL, TARJETACREDITO_IDTARJETACREDITO INTEGER NOT NULL, TIPOPAGO_IDTIPOPAGO INTEGER NOT NULL, PRIMARY KEY (IDPAGO));
