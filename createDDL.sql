...
#Producto prueba
INSERT INTO `libreria`.`producto`
(`IDENTIFICADOR`,`NOMBRE`,
`VALORALQUILERDIA`,`VALORVENTA`,`CATEGORIA_IDCATEGORIA`,
`ESTADODISPONIBILIDAD_IDESTADODISPONIBILIDAD`,`ESTADOPRODUCTO_IDESTADOPRODUCTO`)
VALUES ('PROD1','LIBRO 1',1000,10000,1,1,1);
